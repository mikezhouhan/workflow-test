...
const electronAPI = {
  ...
  setInterfaceLanguage: (language: string) => ipcRenderer.invoke("set-interface-language", language),
  ...
  // 添加读取翻译文件的方法
  readTranslationFile: (language: string) => ipcRenderer.invoke("read-translation-file", language)
}
